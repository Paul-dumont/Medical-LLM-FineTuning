...
from typing import Any, List, Optional, Tuple, Union, Dict, Set, Callable
from transformers.models.phi3.modeling_phi3 import (__name__, Callable, Optional, Union, torch, nn, ACT2FN, Cache, GenerationMixin, use_kernel_forward_from_hub, FlashAttentionKwargs, BaseModelOutputWithPast, CausalLMOutputWithPast, ROPE_INIT_FUNCTIONS, dynamic_rope_update, ALL_ATTENTION_FUNCTIONS, PreTrainedModel, Unpack, TransformersKwargs, can_return_tuple, deprecate_kwarg, Phi3Config, Phi3PreTrainedModel, Phi3Model, Phi3ForCausalLM)

@torch.compile(fullgraph = False, dynamic = True, options = torch_compile_options)
def Phi3MLP_forward(self, hidden_states: torch.FloatTensor) -> torch.FloatTensor:
...
class Phi3MLP(nn.Module):
    ...
    def forward(self, hidden_states: torch.FloatTensor) -> torch.FloatTensor:
        return Phi3MLP_forward(self, hidden_states)
...
class Phi3Attention(nn.Module):
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        return Phi3Attention_forward(self, hidden_states, position_embeddings, attention_mask, past_key_values, cache_position, **kwargs)


@torch.compile(fullgraph = True, dynamic = True, options = torch_compile_options)
def Phi3RMSNorm_forward(self, hidden_states):
...
class Phi3RMSNorm(nn.Module):
    ...
    def forward(self, hidden_states):
        return Phi3RMSNorm_forward(self, hidden_states)
...
def Phi3RotaryEmbedding_forward(self, x, position_ids):
...
class Phi3ForCausalLM(Phi3PreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        return Phi3ForCausalLM_forward(self, input_ids, attention_mask, position_ids, past_key_values, inputs_embeds, labels, use_cache, cache_position, logits_to_keep, **kwargs)
